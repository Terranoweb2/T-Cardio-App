...
export default function Home() {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (token && userStr) {
        try {
          ...
          return; // Keep splash screen while redirecting
        } catch {}
      }
  ...
  // Show splash screen while checking auth / redirecting
  if (isCheckingAuth) {
    return (
      <div className="min-h-screen bg-cardio-900 flex flex-col items-center justify-center">
        <div className="relative mb-6">
          ...
          <div className="relative w-24 h-24 rounded-full bg-cardio-800/80 border border-cyan-500/20 flex items-center justify-center">
            <Image src="/logo-T-Cardio.png" alt="T-Cardio" width={64} height={64} />
          </div>
        </div>
